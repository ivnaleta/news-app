...
export const allMockArticles: Article[] = [
  {
    id: 1,
    title: `Fmr. Manager of DOD Aerospace Threat Program: “UFOs are Real”`,
  ...
  {
    id: 2,
    title: `New Zealand Sentences Cactus Smuggler Caught With 947 Plants Strapped To Her Body`,
    text: "ew Zealand authorities have sentenced a woman who tried in 2019 to smuggle nearly 1,000 cacti and succulents into the country strapped to her body.\n" +
      "\n" +
  ...
  {
    id: 3,
    title: "Disney’s ‘Frozen’ Assists Researchers Analyzing 62-Year-Old Mystery Of Dyatlov Pass",
  ...
  {
    id: 4,
    title: "Punxsutawney Phil Lays Out Cold Hard Facts At Annual Groundhog Day Ceremony",
  ...
  {
    id: 5,
    title: `Spinach In Your Inbox: 2016 Study On Scientists ‘Teaching’ Spinach To Send Emails Goes Viral`,
  ...
  {
    id: 6,
    title: "NC Man Hits 2 Deer With New Car, Then Hits $2 Million In Lottery",
